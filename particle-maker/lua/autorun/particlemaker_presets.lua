    ...
    return {
        ...
        options = {
            Default = {
                ...
                particle_maker_VelocityVariation = '0',
                particle_maker_Spread = '50',
                particle_maker_Delay = '0.2',
                particle_maker_DelayVariation = '0',
                particle_maker_Number = '1',
                particle_maker_DieTime = '3', -- originally just "Particle_DieTime" - was there a reason for this?
                particle_maker_DieTimeVariation = '0',
                particle_maker_StartAlpha = '255',
                particle_maker_EndAlpha = '0',
                particle_maker_StartSize = '10',
                particle_maker_StartSizeVariation = '0',
                particle_maker_EndSize = '20',
                particle_maker_EndSizeVariation = '0',
                ...
                particle_maker_HorizAccelMag = '0',
                particle_maker_HorizAccelAngle = '0',
